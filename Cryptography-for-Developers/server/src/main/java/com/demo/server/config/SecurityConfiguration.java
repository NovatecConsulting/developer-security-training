...
import com.demo.server.error.exception.SecurityConfigurationException;
...
/**
 * {@code SecurityConfiguration} is the base Spring security configuration for Eureka server.
